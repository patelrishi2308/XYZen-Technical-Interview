  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: const SystemUiOverlayStyle(
        ...
        statusBarBrightness:
            Brightness.light, // light == black status bar for IOS.
      ),
      child: Scaffold(
                      ...
                      return Form(
                        ...
                        child: IgnorePointer(
                          ignoring: authState.isLoading ||
                              authState.isGeneratePasswordLoading,
                          child: Column(
                            ...
                            children: [
                              ...
                              AppTextField(
                                ...
                                textInputAction: TextInputAction.next,
                                onChanged:
                                    authStateNotifier.onPasswordFieldChange,
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                              ...
                              AppButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (validate) {
                                    try {
                                      final user = await authStateNotifier
                                          .createUser(
                                      ...
                                      if (user != null) {
                                        await NavigationHelper.navigatePushRemoveUntil(route: const HomeScreen());
                                      }
